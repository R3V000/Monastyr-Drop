export const dropSimulationConfig = {
  ...
  mobOverrides: {
    ...
    2492: {
      ...
      spawnsPerChannel: 2,
      respawnMinutes: 180,
      spawnGroups: [{ spots: 2, respawnMinutes: 180 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      regenMaps: 1
    },
    ...
    8001: {
      ...
      spawnsPerChannel: 12,
      respawnMinutes: 5,
      spawnGroups: [{ spots: 12, respawnMinutes: 5 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 5,
      regenMaps: 3
    ...
    8005: {
      ...
      spawnsPerChannel: 18,
      respawnMinutes: 10,
      spawnGroups: [{ spots: 18, respawnMinutes: 10 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 25,
      regenMaps: 6
    ...
    8006: {
      ...
      spawnsPerChannel: 12,
      respawnMinutes: 10,
      spawnGroups: [{ spots: 12, respawnMinutes: 10 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 30,
      regenMaps: 3
    ...
    8007: {
      ...
      spawnsPerChannel: 12,
      respawnMinutes: 15,
      spawnGroups: [{ spots: 12, respawnMinutes: 15 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 35,
      regenMaps: 3
    ...
    8009: {
      ...
      spawnsPerChannel: 10,
      respawnMinutes: 15,
      spawnGroups: [{ spots: 10, respawnMinutes: 15 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 45,
      regenMaps: 2
    ...
    8012: {
      ...
      spawnsPerChannel: 10,
      respawnMinutes: 20,
      spawnGroups: [{ spots: 10, respawnMinutes: 20 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 60,
      regenMaps: 1
    ...
    8024: {
      ...
      spawnsPerChannel: 12,
      respawnMinutes: 20,
      spawnGroups: [{ spots: 12, respawnMinutes: 20 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 75,
      regenMaps: 3
    ...
    8026: {
      ...
      spawnsPerChannel: 5,
      respawnMinutes: 25,
      spawnGroups: [{ spots: 5, respawnMinutes: 25 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 85,
      regenMaps: 1
    ...
    8051: {
      ...
      spawnsPerChannel: 6,
      respawnMinutes: 40,
      spawnGroups: [{ spots: 6, respawnMinutes: 40 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 105,
      regenMaps: 1
    ...
    8053: {
      ...
      spawnsPerChannel: 6,
      respawnMinutes: 30,
      spawnGroups: [{ spots: 6, respawnMinutes: 30 }],
      killsPerAppearance: 1,
      competitionShare: 1,
      mobLevel: 95,
      regenMaps: 1
